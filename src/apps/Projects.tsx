  ...
  const projects = [
    {
      ...
      tech: ["Node.js", "React", "TypeScript", "Redux Toolkit", "Vite", "Axios"],
      github: "https://github.com/akshit1662002/myCLI", 
      live: "https://www.npmjs.com/package/my-react-cli-app" 
    },
    {
      ...
      github: "https://github.com/akshit1662002/Food-Ordering-App", 
      live: "https://food-ordering-app-live.netlify.app" 
    }
  ];
                ...
                <div key={i} className="project-card">
                    <div className="project-header-row">
                        ...
                        <div className="project-links">
                            {proj.github && (
                                <a href={proj.github} target="_blank" rel="noopener noreferrer" className="project-link" aria-label="GitHub Repository">
                                    <svg viewBox="0 0 24 24">
                            ...
                            {proj.live && (
                                <a href={proj.live} target="_blank" rel="noopener noreferrer" className="project-link" aria-label="Live Demo">
